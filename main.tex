...
\input{klikkModel.tex}

% scale-freeness
\input{klikkScaleFree.tex}

% small-world
\input{klikkSmallWorld.tex}
...
% the model description
\input{csillModel.tex}

% scale-freeness
\input{csillScaleFree.tex}

% small-world
\input{csillSmallWorld.tex}
